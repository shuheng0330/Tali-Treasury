...
| Receipt and claim backend | ✅ Hosted schema ready | Gemini validation, private storage adapter, persistence, duplicate checks, guarded API routes, 69 backend tests, 39 database assertions, hosted schema and demo seed | Configure the deployed API and add signed identity verification |
