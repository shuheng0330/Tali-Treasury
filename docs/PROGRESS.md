...
2. ✅ Configure package v2, create and register the funded mandate, and record
   mandate, capability and recipient identifiers. Opening the demo stream and
   recording its identifier remain.
