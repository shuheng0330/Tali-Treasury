import type { RegisterEventResponse } from '@tali/shared';
...
export function createEventRegisterHandler(deps: {
...
export async function POST(request: Request): Promise<Response> {
  try {
    ...
    return createEventRegisterHandler({
      register: services.registerEvent,
