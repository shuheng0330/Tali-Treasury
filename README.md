...
| Gemini receipt analysis and Supabase claims | **Hosted schema ready** | 69 Vitest tests, 42 pgTAP assertions, and all three active team members verified |
...
Member UI (still wired to mock claim data)
             |
             v
Gemini receipt + private Supabase claims (hosted schema ready)
             |
             v
