...
| Authenticated Set Up Payroll | **Live via local app; hosted rollout pending** | Slush created and funded a verified 12.363385 USDC mandate; registration is durable and idempotent |
